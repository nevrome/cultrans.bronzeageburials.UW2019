...
\begin{textblock*}{65pt}(5pt,150pt)
  \setlength\fboxrule{2pt}%
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
...
## Distance Correlation Overview

![**burial construction**: Mean SED for each region relationship.](figures/correlation_time_series.jpeg){ height=85% }
